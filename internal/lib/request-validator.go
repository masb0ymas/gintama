...
import (
	...
	"gintama/internal/lib/validator"
...
func ValidateRequestQuery(c *gin.Context, obj Validatable) error {
...
func ValidateRequestBody(c *gin.Context, obj Validatable) error {
